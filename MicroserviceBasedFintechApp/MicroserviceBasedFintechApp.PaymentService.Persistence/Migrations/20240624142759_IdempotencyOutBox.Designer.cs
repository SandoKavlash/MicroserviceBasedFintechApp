...
namespace MicroserviceBasedFintechApp.PaymentService.Persistence.Migrations
{
    ...
    [Migration("20240624142759_IdempotencyOutBox")]
    partial class IdempotencyOutBox
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MicroserviceBasedFintechApp.PaymentService.Core.Contracts.Entities.PaymentOrder", b =>
                {
                    ...
                    b.HasIndex("ApiKey", "SecretHashed")
                        .IsUnique()
                        .HasDatabaseName("ix_payment_orders_api_key_secret_hashed");

                    b.ToTable("payment_orders", (string)null);
                });

            modelBuilder.Entity("MicroserviceBasedFintechApp.PaymentService.Core.Contracts.Entities.TransactionalOutBox", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_transactional_out_box");

                    b.HasIndex("ApiKey", "IdempotencyKey")
                        .IsUnique()
                        .HasDatabaseName("ix_transactional_out_box_api_key_idempotency_key");

                    b.ToTable("transactional_out_box", (string)null);
                });
